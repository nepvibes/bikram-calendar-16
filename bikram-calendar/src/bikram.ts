...
export const NP_MONTHS_DATA: number[][] = [
  ...
  [31,32,31,32,31,30,30,30,29,29,30,31,366], // 2019
  ...
  [30,32,31,32,31,31,29,30,30,29,29,31,365], // 2031
  ...
  [30,32,31,32,31,31,29,30,29,30,29,31,365], // 2035
  ...
  [31,32,31,32,31,30,30,29,30,29,30,30,365], // 2049
  ...
  [31,31,32,32,31,30,30,29,30,29,30,30,365], // 2056
  ...
  [31,31,31,32,31,31,30,29,30,29,30,30,365], // 2066
  ...
  [31,32,31,32,31,30,30,29,30,29,30,30,365], // 2076
  ...
  [31,32,31,32,31,30,30,29,30,29,30,30,365], // 2080
  [31,32,31,32,31,30,30,30,29,29,30,31,366], // 2081
  [31,31,32,31,31,31,30,29,30,29,30,30,365], // 2082
  [31,31,32,31,31,31,30,29,30,29,30,30,365], // 2083
  [31,32,31,32,31,30,30,29,30,29,30,30,365], // 2084
  [31,32,31,32,31,30,30,30,29,29,30,31,366], // 2085
...
export class BikramDate {
  ...
  constructor(year?: number, month?: number, day?: number) {
    ...
    if (year !== undefined && month !== undefined && day !== undefined) {
      ...
      // Default to current date in Nepal timezone
      this.englishDate = convertToNepalTimezone(new Date());
  ...
  static fromDate(date: Date): BikramDate {
    // Ensure the date is in Nepal's timezone
    const nepalDate = convertToNepalTimezone(date);
    
    const bikramDate = new BikramDate();
    const { bsYear, bsMonth, bsDay } = bikramDate.fromGregorian(
      nepalDate.getFullYear(),
      nepalDate.getMonth() + 1,
      nepalDate.getDate()
    );
